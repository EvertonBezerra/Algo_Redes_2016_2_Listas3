## Exercício 1 ##
## Faz a classificação de uma pessoa base em algumas perguntas. ##
'''
for i in range(10):
    contador_sim = 0
    contador_nao = 0
...
## Exercício 2 ##
## Informa se o número digitado é par ou ímpar, mostrando na tela os digitados, os pares e ímpares. ##
'''
numeros = []
num_par = []
num_impar = []
...
## Eercício 3 ##
## Mostra na tela os números digitados, a soma e multiplicação. ##
'''
numeros = []
soma = 0
multiplicacao = 1
for i in range(10):
    numero = int(input("Digite um número: "))
    numeros.append(numero)
    multiplicacao = multi´licacao * numero
    soma = soma + numero
print('O resultado da soma dos números eh: ',soma)
print('O resultado da multiplicação dos números eh: ',multiplicacao)
print('Total de numeros  digitados: ',numeros)
'''

## Exercício 4 ##
## Clasificação de usuário, com relação ao uso do computador. ##
'''
for i in range(5):
    contador_sim = 0
    contador_nao = 0
